 ...
 * @property {string} WordpressPkg.version - The current version of WordPress
 * @property {string} WordpressPkg.language - The language of WordPress
 * @property {WPMMconfigWP} WordpressPkg.config - The wp-config.php file data
 *
