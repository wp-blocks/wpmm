 ...
 *
 * the WordPress configuration dataset
 * @typedef {Object} WordpressPkg - The WordPress pkg related data for the website
 * @property {string} name - The name of the website
 * @property {string=} version - The current version of WordPress
 * @property {string=} source - the source of the New WordPress installation
 * @property {string=} language - The language of WordPress
 * @property {WPMMconfigWP} WP_config - The wp-config.php file data
 *
 * Website configuration
 * @typedef WPMMconfig - The website configuration
 * @property {WordpressPkg} wordpress - The WordPress data for the website
 * @property {WPMMconfigPkg[]} themes - The themes used
 * @property {WPMMconfigPkg[]} plugins - The plugins used
 * @property {Object=} database - The database data
 * @property {string=} database.type - The type of database
 * @property {string=} database.backupFolder - The path to the backup folder
