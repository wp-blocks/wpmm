...
/**
 * @typedef WPMMconfigWP
 * @property {string} WPMMconfigWP.DB_NAME - The name of the database
 * @property {string} WPMMconfig.DB_USER - The username for the database
 * @property {string} WPMMconfig.DB_PASSWORD - The password for the database
 * @property {string} WPMMconfig.DB_HOST - The host name or IP address of the database server
 * @property {string} WPMMconfig.DB_CHARSET - The character set for the database
 * @property {string} WPMMconfig.DB_COLLATE - The collation for the database (usually utf8_general_ci)
 * @property {string} WPMMconfig.table_prefix - The table prefix for the database
 * @property {boolean} WPMMconfig.WP_DEBUG - Whether to enable debugging
 * @property {string} WPMMconfig.WP_SITEURL - The URL of the website
 * @property {string} WPMMconfig.WP_HOME - The home URL of the website
 * @property {string} WPMMconfig.WP_CONTENT_DIR - The path to the content directory
 * @property {string} WPMMconfig.WP_CONTENT_URL - The URL of the content directory
 * @property {boolean} WPMMconfig.DISALLOW_FILE_EDIT - Whether to disallow file editing
 */

/**
 * @typedef WPMMconfigPkg
 * @property {string} WPMMconfigPkg.name - the name of the package
 * @property {string} WPMMconfigPkg.version - the version of the package
 * @property {string} WPMMconfigPkg.source - the source of the package
 */

/**
 * @typedef WPMMconfig
 * @property {string} WPMMconfig.name - The name of the website
 * @property {Object} WPMMconfig.wordpress - The WordPress pkg related data for the website
 * @property {string} WPMMconfig.wordpress.version - The current version of WordPress
 * @property {string} WPMMconfig.wordpress.language - The language of WordPress
 * @property {WPMMconfigWP} WPMMconfig.wordpress.config - The wp-config.php file data
 * @property {WPMMconfigPkg[]} WPMMconfig.themes - The themes used
 * @property {WPMMconfigPkg[]} WPMMconfig.plugins - The plugins used
 * @property {WPMMconfigPkg[]} WPMMconfig.database - The database data
 * @property {string[]} WPMMconfig.postInstall - The post-install actions run by wp-cli
 */
