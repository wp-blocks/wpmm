...
const fs = require("fs");
const {geVarFromPHPFile} = require("./data.js");
const axios = require("axios");
const {defaultWpInstallFolder} = require("../constants.js");
const {defaultWpInstallLanguage} = require("../constants");
...
function getWordPressPaths (config, rootFolder = process.cwd()) {
  const baseFolder = path.join(rootFolder, config.name ?? defaultWpInstallFolder);
  return {
