 ...
 * @param {string} [baseFolder='wordpress'] - The base folder path for the WordPress installation. Defaults to 'wordpress'.
...
function getWordPressPaths (config, rootFolder = process.cwd()) {
  return {
    ...
    baseFolder: path.join(rootFolder, config.name ?? 'wordpress'),
