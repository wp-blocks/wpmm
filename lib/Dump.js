...
const { geVarFromPHPFile, getUserLocale} = require('./utils');
const {config} = require("yargs");
const {getWordPressPaths, getCurrentWpInfo} = require("./utils/wpConfig");
...
class Dump {
   ...
   */
  constructor (paths) {
    this.wpFolder = paths.rootFolder;
  ...
  init () {
    ...
    const version = wpInfo.version || this.getLastVersion();
