import { getDownloadUrl, getWordPressDownloadUrl } from '../src/utils/data'
import { generateSalt, getDataFromFile, replaceDbConstant, replaceDbConstantBool } from '../src/utils/parsers'
import { initConfig } from '../src/utils/data'
...
test('replaceConstant', () => {
    ...
    expect(replaceDbConstantBool(content2, name2, value2)).toBe(
        expectedContent2
    )
})
