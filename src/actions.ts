...
import { getInfo } from "./utils/data.js";
import { isValidUpdateOptions } from "./utils/parsers.js";
...
export function actions({
	...
	config: WPMMconfig;
	paths: WPMMpaths;
}): { invokeAction: (key: string, argv: Argv) => void } {
	/**
	 * The actions object.
	 */
	const wpmmActions: {
	...
	return {
		 ...
		 */
		invokeAction: (key: string, argv: Argv) => {
